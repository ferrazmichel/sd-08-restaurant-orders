...
def analyze_log(path_to_file):
    ...
    maria_order = most_ordered_meal('maria', data)
    arnaldo_order = how_many_times_burguer_was_ordered('arnaldo', data)
    joao_not_ordered = food_never_ordered('joao', data)
    joao_never_went = never_went_to_diner('joao', data)

    converted_str = f"{maria_order}\n{arnaldo_order}\n{joao_not_ordered}\n{joao_never_went}\n"
